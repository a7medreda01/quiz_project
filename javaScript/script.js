...
form.addEventListener("submit", function(event) {
  ...
  if(user.value =='' || lastNameIn.value == '' || emailIn.value==''||  passwordIn.value=='' ){
    console.log("data not valid")
    
}else{
    
     var userForm = { firstName: user.value, lastName: lastNameIn.value,email :emailIn.value,password :passwordIn.value };
...
loginForm.addEventListener("submit", function(event) {
  ...
  if(loginEmail== emailLogin.value && loginPassword==passwordLogin.value ){
